...
export function InputIconRoot(props: InputIconRootProps) {
  return (
...
export function InputFieldRoot(props: InputFieldRootProps) {
  return (
    <input
      className="peer flex-1 outline-0 placeholder-gray-400"
      {...props}
    />
  );
}
